...
@Component({
  selector: 'app-tipo-bien-mueble-form',
  standalone: true,
  imports: [
    CommonModule,
    ButtonComponent,
  ...
  templateUrl: './tipo-bien-mueble-form.component.html',
  styleUrl: './tipo-bien-mueble-form.component.css'
})
export class TipoBienMuebleFormComponent
{
