...
@Component({
  selector: 'app-subtipos-garantia-form',
  standalone: true,
  imports: [
    CommonModule,
    ButtonComponent,
  ...
  templateUrl: './subtipos-garantia-form.component.html',
  styleUrl: './subtipos-garantia-form.component.css'
})
export class SubtiposGarantiaFormComponent
{
